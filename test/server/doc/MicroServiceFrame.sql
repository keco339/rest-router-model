...
-- -----------------------------------------------------
-- Table `MicroServiceFrameDB`.`Users_Groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MicroServiceFrameDB`.`Users_Groups` ;

CREATE TABLE IF NOT EXISTS `MicroServiceFrameDB`.`Users_Groups` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `uuid` CHAR(30) NOT NULL,
  `userUUID` CHAR(30) NULL,
  `groupUUID` CHAR(30) NULL,
